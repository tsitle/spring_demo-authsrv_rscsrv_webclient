...
application {
	...
	mainClass.set("com.ts.springdemo.oauthwebclient.SpringDemoOauthWebClientApplicationKt")
}
...
dependencies {
	...
	implementation("org.springframework.boot:spring-boot-starter-validation")  // for validating HTML forms
